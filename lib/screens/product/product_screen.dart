...
class _ProductScreenState extends State<ProductScreen> {
  ...
  Future<Product?> _getProduct() async {
    ...
    final carouselViewModel =
        Provider.of<ProductCarouselViewModel>(context, listen: false);
    final reviewViewModel =
        Provider.of<ProductReviewViewModel>(context, listen: false);
  ...
  void _purchaseNow() {
    ...
    final checkoutVoucherViewModel =
        Provider.of<CheckoutVoucherViewModel>(context, listen: false);
    final checkoutPaymentMethodViewModel =
        Provider.of<CheckoutPaymentMethodViewModel>(context, listen: false);
                ...
                children: [
                            ...
                            children: [
                              ...
                              Positioned(
                                ...
                                child: Row(
                                  ...
                                  children: state.product!.imageUrl!
                                      .asMap()
                                      .entries
                                      .map((entry) {
                                    return Container(
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          color: entry.key == state.currentIndex
                                              ? warning20
                                              : neutral20),
                                    );
                                  }).toList(),
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style:
                                        regularBody5.copyWith(color: neutral20),
                                  )
                                ],
                              )
                            ],
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 10),
                      Consumer<ProductViewModel>(builder: (context, state, _) {
                        return FutureBuilder(
                            ...
                            Column(
                              ...
                              children: [
                                Text(
                                  'Ulasan',
                                  style:
                                      semiBoldBody5.copyWith(color: primary40),
                                ),
                    ...
                    Expanded(
                      child: Consumer<ProductViewModel>(
                        ...
                        return ElevatedButton(
                          onPressed:
                              state.product!.stock! > 0 ? _purchaseNow : null,
                          style: ElevatedButton.styleFrom(
                            backgroundColor: primary40,
                            shape: const BeveledRectangleBorder(),
                          ),
