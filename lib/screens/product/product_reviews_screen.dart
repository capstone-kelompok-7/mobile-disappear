                          ...
                          child: Column(
                            children: [
                              Text(
                                ...
                                style: boldTitle4.copyWith(color: primary40),
                              ),
                              const SizedBox(
                                height: 4,
                              ),
                              ...
                              Text(
                                'berdasarkan ${snapshot.data.reviews.length} ulasan',
                                style: regularBody7,
                              ),
                            ],
                          ),
                                ...
                                children: [
                                  ...
                                  Expanded(
                                      ...
                                      child: LinearProgressIndicator(
                                        ...
                                        value: snapshot.data.currentRatingFive >
                                                0
                                            ? snapshot.data.currentRatingFive /
                                                snapshot.data.totalReview
                                            : 0,
                                        valueColor:
                                  ...
                                  Expanded(
                                    ...
                                    child: LinearProgressIndicator(
                                      ...
                                      value: snapshot.data.currentRatingFour > 0
                                          ? snapshot.data.currentRatingFour /
                                              snapshot.data.totalReview
                                          : 0,
                                      valueColor:
                                          const AlwaysStoppedAnimation<Color>(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    ...
                                    child: LinearProgressIndicator(
                                      minHeight: 5,
                                      backgroundColor: neutral00,
                                      value: snapshot.data.currentRatingThree >
                                              0
                                          ? snapshot.data.currentRatingThree /
                                              snapshot.data.totalReview
                                          : 0,
                                      valueColor:
                                          const AlwaysStoppedAnimation<Color>(
                                  ...
                                  Expanded(
                                    ...
                                    child: LinearProgressIndicator(
                                      ...
                                      value: snapshot.data.currentRatingTwo > 0
                                          ? snapshot.data.currentRatingTwo /
                                              snapshot.data.totalReview
                                          : 0,
                                      valueColor:
                                          const AlwaysStoppedAnimation<Color>(
                                  ...
                                  Expanded(
                                    ...
                                    child: LinearProgressIndicator(
                                      ...
                                      value: snapshot.data.currentRatingOne > 0
                                          ? snapshot.data.currentRatingOne /
                                              snapshot.data.totalReview
                                          : 0,
                                      valueColor:
                                          const AlwaysStoppedAnimation<Color>(
