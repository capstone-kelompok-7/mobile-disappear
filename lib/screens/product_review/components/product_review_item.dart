            ...
            Row(
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(widget.review.name.isNotEmpty
                        ? widget.review.name
                        : 'User'),
                    const SizedBox(
                      width: 5,
                    ...
                    Row(
                      children: [
                        Icon(
                          color:
                              widget.review.rating >= 1 ? warning30 : neutral00,
                          Icons.star,
                          size: 18,
                        ),
                        ...
                        Icon(
                          color:
                              widget.review.rating >= 2 ? warning30 : neutral00,
                          Icons.star,
                          size: 18,
                        ),
                        const SizedBox(width: 2),
                        Icon(
                          color:
                              widget.review.rating >= 3 ? warning30 : neutral00,
                          Icons.star,
                          size: 18,
                        ),
                        const SizedBox(width: 2),
                        Icon(
                          color:
                              widget.review.rating >= 4 ? warning30 : neutral00,
                          Icons.star,
                          size: 18,
                        ),
                        const SizedBox(width: 2),
                        Icon(
                          color:
                              widget.review.rating >= 5 ? warning30 : neutral00,
                          Icons.star,
                          size: 18,
                        ),
