      ...
      body: ListView(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              const Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Totebag Kanvas', style: semiBoldBody6,),
                  SizedBox(height: 7,),
          ...
          Row(
            ...
            children: [
              const Text('Kualitas Produk', style: mediumBody5,),
          ...
          Row(
            ...
            children: [
              ElevatedButton(
                ...
                child: Text('Batal', style: semiBoldBody7.copyWith(color: primary40),)
              ),
              ...
              Consumer<AddProductReviewViewModel>(
                builder: (context, state, _) {
                  return ElevatedButton(
                    ...
                    child: const Text('Nilai', style: semiBoldBody7,)
                  );
                }
              ),
            ],
