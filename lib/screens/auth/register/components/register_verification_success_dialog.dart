...
class RegisterVerificationSuccessDialog extends StatefulWidget {
  const RegisterVerificationSuccessDialog({
    super.key,
  ...
  @override
  State<RegisterVerificationSuccessDialog> createState() => _RegisterVerificationSuccessDialogState();
}
