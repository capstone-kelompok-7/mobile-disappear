...
class SentCard extends StatelessWidget {
  ...
  const SentCard({super.key, this.onTap});
  @override
  Widget build(BuildContext context) {
    return InkWell(
      onTap: onTap,
              ...
              children: [
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text('Pesanan sedang diantar ke alamat tujuan',
                ...
                Padding(
                  ...
                  child: Align(
                    ...
                    child: Text(
                      'Silahkan konfirmasi setelah menerima \ndan mengecek pesanan',
                      style: regularBody4.copyWith(fontSize: 12, height: 1.2),
                    ),
                  ),
                ),
              ],
