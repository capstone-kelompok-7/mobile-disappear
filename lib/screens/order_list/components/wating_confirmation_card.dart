...
class WaitingConfirmationTabCard extends StatefulWidget {
  final OrderAllUserModel order;
  const WaitingConfirmationTabCard({
    Key? key,
    required this.order,
  }) : super(key: key);

  @override
  State<WaitingConfirmationTabCard> createState() =>
      _WaitingConfirmationTabCardState();
}

class _WaitingConfirmationTabCardState
    extends State<WaitingConfirmationTabCard> {
