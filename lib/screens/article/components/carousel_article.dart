...
class CarouselArticle extends StatelessWidget {
  ...
  Widget _buildView(state, AsyncSnapshot snapshot) {
    return ClipRRect(
        ...
        child: CarouselSlider(
          ...
          items: snapshot.data!.map<Widget>((carouselModel) {
            return Image.network(carouselModel.photo,
  ...
  Widget build(BuildContext context) {
    return Consumer<CarouselViewModel>(builder: (context, state, _) {
